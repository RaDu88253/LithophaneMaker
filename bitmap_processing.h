...
void read_bitmap_header(FILE *input, struct bmp_file_info *fisier); //reads the 14 byte header
void read_DIB_header(FILE *input, struct bmp_file_info *fisier); //reads the dib header and sets parameters inside the passed file info object
